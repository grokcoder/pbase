...
public class StoreFile {
    ...
    public static class WriterV2 implements Compactor.CellSink {
        ...
        public WriterV2(Configuration conf, FileSystem fs, Path file, MessageType schema){
            this.filePath = file;
            this.schema = schema;
            gf = new SimpleGroupFactory(schema);
            GroupWriteSupport.setSchema(schema, conf);
            writer = new PFileWriter(conf, schema, new GroupWriteSupport(null))
                    .addPath(file)
                    .build();
        }
     ...
     * to build writer-v2
     */
    public static class WriterBuilderV2 {
        private final Configuration conf;
        //private final CacheConfig cacheConf;
        private final FileSystem fs;
        ...
        public WriterBuilderV2(Configuration conf,
        ...
        public WriterBuilderV2 addSchema(MessageType schema){
            this.schema = schema;
            return this;
        }
        ...
        /**
         * Use either this method or {@link #addFilePath}, but not both.
         * @param dir Path to column family directory. The directory is created if
         *          does not exist. The file is given a unique name within this
         *          directory.
         * @return this (for chained invocation)
         */
        public WriterBuilderV2 addOutputDir(Path dir) {
            Preconditions.checkNotNull(dir);
            this.dir = dir;
            return this;
        }
        ...
        /**
         * Use either this method or {@link #addOutputDir}, but not both.
         * @param filePath the StoreFile path to write
         * @return this (for chained invocation)
         */
        public WriterBuilderV2 addFilePath(Path filePath) {
            Preconditions.checkNotNull(filePath);
            this.filePath = filePath;
            return this;
        }
         ...
         * @return this (for chained invocation)
         */
        public WriterBuilderV2 addFavoredNodes(InetSocketAddress[] favoredNodes) {
            this.favoredNodes = favoredNodes;
            return this;
        }
        ...
        /**
         * Create a store file writer2. Client is responsible for closing file when
         * done. If metadata, add BEFORE closing using
         * {@link Writer#appendMetadata}.
         */
        public WriterV2 build() throws IOException {
            if ((dir == null ? 0 : 1) + (filePath == null ? 0 : 1) != 1) {
                throw new IllegalArgumentException("Either specify parent directory " +
                        "or file path");
            }
            ...
            return new WriterV2(this.conf, this.fs, this.filePath, this.schema);
        }
